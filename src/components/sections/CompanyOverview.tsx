      ...
      <div className="mx-auto max-w-6xl">
        <div className="grid gap-12 lg:grid-cols-2 lg:gap-16 lg:items-center">
          ...
          >
            ...
            <h2
              id="overview-heading"
              className="font-[--font-poppins] text-3xl font-bold text-[#0A2E4F] md:text-4xl"
            >
              We deliver integrated solutions for sustainable energy and built environment projects.
            </h2>
            <p className="max-w-xl leading-relaxed text-[#333333]">
              <strong className="text-[#0A2E4F]">MAVERICK Energy Partners (MEP)</strong> is a specialized hydropower project development and consulting firm backed by over 100 years of combined industry experience. Our team delivers end-to-end solutions for government agencies, corporations, and investors worldwide.
            </p>
            <p className="max-w-xl leading-relaxed text-[#333333]">
          ...
          <motion.div
            ...
            viewport={{ once: true, margin: "-60px" }}
            transition={{ duration: 0.5 }}
            className="relative aspect-[4/3] overflow-hidden rounded-xl bg-[#F4F6F8]"
          >
            <video
              autoPlay
              loop
